...
def connectToClients():
    ...
    #It returns the sender Socket and the reciever Socket
...
def forwardMessage(encryptMessage, socketReceiver):
    ...
    #a. encyptMessage: This is the encrypted message recteved from Alice.
    #b. socketReciever: This is the address socket of the reclever (Bob).
...
def closeConnection(socketSender, socketReceiver):
    #Input paraneters: This function takes in: 
    # a. socketSender: This is the address socket of the sender (Alice). 
    # b. socketReciever: This is the address socket of the rectever (Bob)
...
#sender and then forwards it to the rectever. 
